...
def extract_handbook_info():
    """
        Extract info from
        https://rbi.org.in/Scripts/AnnualPublications.aspx?head=Handbook%20of%20Statistics%20on%20Indian%20Economy
    """
    handbook_url = \
        r"https://rbi.org.in/Scripts/AnnualPublications.aspx?head=Handbook%20of%20Statistics%20on%20Indian%20Economy"
...
def download_all_files(raw_data_dir: str):
    ...
    try:
        ...
        current_title = create_title_file(raw_data_dir)
    ...
    for _title, _url in extract_handbook_info():
        ...
        if xlsx_filename not in current_title:
            ...
            urlretrieve(_url, os.path.join(raw_data_dir, xlsx_filename))
        current_title[xlsx_filename] = _title
        print("Writing ")
...
def test():
    ...
    download_all_files(raw_data_dir)


def print_file():
    for index, (_title, _url) in enumerate(extract_handbook_info()):
